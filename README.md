...
To begin, I struggled with the planning for this project. I put a lot of effort in helping others with there individual projects and also took the lead in the group project. In the end I had to less time remaining to complete my own individual project. So, in the future it would be smart to better set my priorities and divide my time. In this way I can also reduce my stress-level. Besides, I also noticed it wasn't very helpfull for my planning that I started over for a couple of times. In the beginning I had the idea to use some frameworks which I tested and started to implement, but in the end there wasn't a fit with the project so I didn't want to implement further. In the future I would like ...

My next reflection punt feedback gesprekken aantal gemsit en niet herpland wat zonde is. In de toekomst kan ik dit beter 

Uitgebreid ging je uitzoeken > wel goede informatie > veel te weinig tijd hebt

Finally, good project opgeleverd als je kijkt naar de kwaliteit. In de toekomst zou ik dit hetzelfde willen doen, maar uiteraard als ik bovenstaande punten ook toepas. 

Uiteindelijk denk ik dat ik met de kennis die ik opgedaan tijdens dit semester klaar ben om stage te gaan lopen. Er zijn een aantal leerpunten, maar aangezien ik me hier bewust van ben, kan ik hier aan werken en zal dit in de toekomst naar verwachting ook anders gaan. 

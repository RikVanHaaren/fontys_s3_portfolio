...
- [2. Learning Outcomes](#2-learning-outcomes)
  * [2.1 Web application](#21-web-application)
    + [2.1.1 User-friendly <br/>](#211-user-friendly--br--)
    + [2.1.2 Full-stack](#212-full-stack)
  * [2.2 Software quality](#22-software-quality)
    + [2.2.1 Tests <br/>](#221-tests--br--)
    + [2.2.2 Security <br/>](#222-security--br--)
    + [2.2.3 Performance <br/>](#223-performance--br--)
    + [2.2.4 Static Code Analysis / code reviews](#224-static-code-analysis---code-reviews)
  * [2.3 Agile method](#23-agile-method)
  * [2.4 CI/CD](#24-ci-cd)
  * [2.5 Cultural differences and ethics](#25-cultural-differences-and-ethics)
    + [2.5.1 Cultural differences](#251-cultural-differences)
    + [2.5.2 Ethics](#252-ethics)
